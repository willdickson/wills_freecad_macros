...
Simple macro which resyncs the aliases in a spreadsheet. 
...
sync when inserting/deleting rows and coloumns.  
...
FreeCAD.Console.PrintMessage(f'resyncing aliases\n') 
